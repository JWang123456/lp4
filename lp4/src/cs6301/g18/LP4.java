...
public class LP4 {
    ...
    public long countTopologicalOrders() {
    	...
    	for(Vertex s: g) {
    		...
    		nums.put(s.getName(), s);
    		   ...
    		   backtrack(list, new ArrayList<>(), nums, visited, indegree);
    ...
    private void backtrack(List<List<Vertex>> list, List<Vertex> tempList, HashMap<Integer, Vertex> nums, boolean[] visited, Integer[] indegree){
